...
<html>
    ...
    <body style="height: 100%">
      <?php
        ...
        //     $recip_id = $db_connection->query("SELECT recipient_id FROM reports WHERE id = ".$value->GetID());
        //     if (!$recip_id) {
        //       echo $db_connection->error;
        //       exit();
        //     }
        //     $recip_id = $recip_id->fetch_assoc()['recipient_id'];
        //     $receiver = User::FetchBy(['select_list' => 'id, received_reports', 'is_unique' => true, 'eq_conds' => ['id' => $recip_id]]);
        //     $received = $receiver->GetReceivedReports();
        //     echo 'received_before:';
        //     var_dump($received);
        ...
        //     echo '<br>';
        //     echo 'UPDATE users SET received_reports = "'.($db_connection->real_escape_string(json_encode($received))).'" WHERE id = '.($receiver->GetID()).'<br>';
        ...
        //     echo '<br>';
        //     echo 'UPDATE users SET sended_reports = "'.($db_connection->real_escape_string(json_encode($sended))).'" WHERE id = '.($sender->GetID()).'<br>';
